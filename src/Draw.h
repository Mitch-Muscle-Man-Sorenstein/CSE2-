...
void PutBitmap3(const RECT *rcView, float x, float y, const RECT *rect, SurfaceID surf_no);
void PutBitmap4(const RECT *rcView, float x, float y, const RECT *rect, SurfaceID surf_no);
